...
class WxHttpClient extends HttpClient {
    constructor(logger) {
        super();
        this.logger = logger;
    }
        ...
        return new Promise((resolve, reject) => {
            ...
            conf.success = ({ data, statusCode }) => {
                ...
                if (statusCode >= 200 && statusCode < 300) {
                    ...
                    let dataString = "";
                    if (data instanceof ArrayBuffer) {
                        dataString = WxHttpClient_utf8ArrayToString(new Int32Array(data));
                    }
                    else if (dataType !== "string" && dataType !== "undefined") {
                        dataString = JSON.stringify(data);
                    }
...
function WxHttpClient_utf8ArrayToString(array) {
    let out = "";
    let i = 0;
    const len = array.length;
    let c;
 ...
 */
const UniWebSocket = (_a = class UniSocket {
 ...
 */
const WxWebSocket = (WxWebSocket_a = class WxSocket {
        get url() { return this._url; }
        get bufferedAmount() { return 0; }
        get extensions() { return ""; }
        get protocol() { return ""; }
        ...
        constructor(url, protocols, options) {
            ...
            const socket = wx.connectSocket(connectOption);
            this._socket = socket;
            socket.onOpen(() => {
                if (this.onopen) {
                    const ev = { type: "open" };
    ...
    WxWebSocket_a.CLOSED = 3,
    WxWebSocket_a.CLOSING = 2,
    WxWebSocket_a.OPEN = 1,
    WxWebSocket_a.CONNECTING = 0,
    WxWebSocket_a);
...
class HttpConnection {
    ...
    _resolveNegotiateUrlCompatible(url) {
