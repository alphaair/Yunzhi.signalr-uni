...
exports.UniHttpClient = void 0;
const Errors_1 = require("./Errors");
const HttpClient_1 = require("./HttpClient");
const ILogger_1 = require("./ILogger");
class UniHttpClient extends HttpClient_1.HttpClient {
    constructor(logger) {
        super();
        this.logger = logger;
    }
    send(request) {
        ...
        return new Promise((resolve, reject) => {
            ...
            conf.fail = ({ errMsg }) => {
                self.logger.log(ILogger_1.LogLevel.Error, `(UniHttpClient) Request failed, message: ${errMsg}.`);
                let err;
