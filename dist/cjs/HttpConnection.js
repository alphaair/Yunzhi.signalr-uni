...
const UniWebSocket_1 = require("./UniWebSocket");
const WxWebSocket_1 = require("./WxWebSocket");
...
class HttpConnection {
    constructor(url, options = {}) {
        ...
        //适配uni-app平台合并代码
        if (Utils_1.Platform.isUni && !options.WebSocket) {
            options.WebSocket = UniWebSocket_1.UniWebSocket;
        }
        else if (Utils_1.Platform.isWechatMP && !options.WebSocket) {
            options.WebSocket = WxWebSocket_1.WxWebSocket;
        }
        else if (!Utils_1.Platform.isNode && typeof WebSocket !== "undefined" && !options.WebSocket) {
    ...
    _resolveNegotiateUrl(url) {
        if (Utils_1.Platform.isUni || Utils_1.Platform.isWechatMP)
